...
struct measure_time_with_name_t {
    ...
    {&mt_drp_ai_yolo_resize, "resize", "YoloObjectDetect"},
    ...
    {&mt_drp_ai_yolo_pre, "PreRuntime::Pre", "YoloObjectDetect"},
    {&mt_drp_ai_yolo_set_input, "MeraDrpRuntimeWrapper::SetInput", "YoloObjectDetect"},
    {&mt_drp_ai_yolo_run, "MeraDrpRuntimeWrapper::Run", "YoloObjectDetect"},
    ...
    {&mt_drp_ai_yolo_receive_result, "Receive result", "YoloObjectDetect"},
